                ...
                <div className='flex flex-1 flex-col gap-3 p-5'>
                      <span className="text-sm font-medium text-slate-300">
                        ...
                        {shouldShowOnboarding ? (
                          <p className="text-sm leading-6 text-slate-400">
                          Comece <button className='font-md text-lime-400 hover:underline'>gravando uma nota</button> em aúdio ou se preferir <button onClick={handleStartEditor} className='font-md text-lime-400 hover:underline'>utilize apenas texto</button>
                            </p>
                        ) : (
