...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
  return (
      ...
      <Dialog.Content className='overflow-hidden inset-0 md:inset-auto fixed md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] md:h-[60vh] w-full bg-slate-700 rounded-md flex flex-col outline-none'>
